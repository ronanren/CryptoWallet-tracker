...
def get_economics_egld():
    try:
        ...
        print("get_economics_egld exception : " + e)
        message = "Error to get egld economics"
    return message
...
def get_account_delegation_egld(address):
    try:
        ...
        print("get_account_delegation_egld exception : " + e)
        message = "Error to get account delegation egld"
    return message
...
def check_new_elrond_transaction(address, bot, chat_id):
    try:
        ...
        print("check_new_elrond_transaction exception : " + e)
        message = "Error to check new elrond transaction"
